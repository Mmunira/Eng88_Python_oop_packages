...
class Reptile(Animal):
    ...
    def __init__(self):
        # we have a keyword called SUPER which inherits everything from parent class at the time of initialisation of this class
        super().__init__()
        self.cold_blooded = True
        self. tetrapod = None # not all reptiles are tetrapd
...
print("This function is from a Reptile class" + reptile_object.hunt())
